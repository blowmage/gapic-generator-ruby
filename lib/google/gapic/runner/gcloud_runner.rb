...
require 'google/gapic/generator/gcloud_generator'
require 'google/gapic/generator/gcloud_template_provider'
    ...
    module Runner
      class GcloudRunner
        ...
        def run
          ...
          generator = Google::Gapic::Generator::GcloudGenerator.new(api, template_provider)
        ...
        def template_provider
          ...
          Google::Gapic::Generator::GcloudTemplateProvider.new(template_path)
        end
        ...
        def format_file file
          ...
          # TODO: This should happen in the generator, not in the runner.
